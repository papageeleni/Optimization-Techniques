%This is the code for the steepest descent method with gamma selected based optimization method "golden method" 
...
for i=1:length(x0)
    ...
    while 1    %finds the point and the grad
        ...
        h(g)=f(temp_2(1), temp_2(2));
        if golden_method(h,-4,3,0.1) >= 0
            gamma = golden_method(h,-4,3,0.1);
        end
